const DEPLOYED_REDIRECT_URI = "https://oceanrelay.onrender.com/oauth/callback";
...
function validateHttpUrl(value, { name, requireCallbackPath }) {
  ...
  if (requireCallbackPath && url.hostname === "oceanrelay.onrender.com" && url.origin + url.pathname !== DEPLOYED_REDIRECT_URI) {
